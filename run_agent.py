        ...
        *,
        ...
        try:
            ...
            _lifecycle.invoke_hook(
                ...
                request_metadata=getattr(self, "_request_metadata", None) or {},
            )
        except Exception:
            pass
    ...
    def _sync_external_memory_for_turn(
        ...
        *,
        ...
        try:
            ...
            if (
                (self.platform or "").strip() != "api_server"
    ...
    def run_conversation(
        ...
        try:
            ...
            with (
                ...
                scoped_runtime_main({}),
                attribute_auxiliary_usage(self),
            ):
                try:
                    ...
                    # Every gateway snapshot happens after this public run
                    # boundary. Fold advisor accounting even when the loop
                    # exits before its normal aggregator-usage block.
                    try:
