...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def _auto_recall_query(self, query: str) -> str:
        """Normalize and bound the query used by Dorvis' empty-buffer fallback."""
        query = query or ""
    ...
    def _same_turn_recall_allowed(self) -> bool:
        """Whether an empty warmed prefetch may fall back to live recall."""
    ...
    def _recall_context_text(self, query: str) -> str:
        """Compatibility wrapper for the Dorvis same-turn fallback."""
        recalled = self._do_recall(query)
        self._same_turn_recall_count = recalled.count
