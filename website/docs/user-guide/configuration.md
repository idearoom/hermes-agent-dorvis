...
- `allow_anydoc` — when `false`, disables the optional AnyDoc converter before import or lazy installation. The bounded native DOCX, XLSX, and notebook readers remain enabled.
