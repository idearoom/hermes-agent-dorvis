...
compression:
  ...
  small_context_threshold_floor: true  # Raise sub-512K models to at least 75%
...
| `small_context_threshold_floor` | `true` | bool | Raise sub-512K model thresholds to at least 75%. Set `false` to preserve `threshold` exactly |
