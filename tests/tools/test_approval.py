...
class TestDetectDangerousRm:
    ...
    def test_nonrecursive_verification_artifact_cleanup_is_not_dangerous(self):
        # The exemption deliberately accepts only the canonical temp path.
        # On macOS, /tmp is a symlink to /private/tmp, so hard-coding /tmp
        # contradicts the symlink-escape assertion immediately below.
