...
def _get_pre_tool_call_directive_details(
    ...
    # Preserve the legacy callback shape for callers that do not provide
    # request metadata, while forwarding Dorvis' request-scoped provenance
    # intact whenever the runtime supplies it.
    if request_metadata is not None:
        hook_kwargs["request_metadata"] = request_metadata
